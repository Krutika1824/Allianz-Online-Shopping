    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_left">
        	<div class="templatemo_content_left_section">
            	...
            	<li><a href="ProductController?action=getAllProductByCategoryId&CategoryId=${category.category_id}">${category.category_code}${category.category_decs}</a></li>
   	      ...
   	      <img src="images/templatemo_image_01.jpg" alt="image" />
                <div class="product_info">
                  ...
                  <h3>Rs.${product.price}</h3>
                    <div class="buy_now_button"><a href="ProductController?action=Addtocart&productid=${product.id}">Buy Now</a></div>
                    <div class="detail_button"><a href="ProductController?action=getDetailById&productId=${product.id}">Detail</a></div>
                </div>
